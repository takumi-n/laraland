...
<template>
    ...
    >
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div
                class="flex justify-center pt-8 sm:justify-start sm:pt-0 text-red-500 text-7xl"
            >
                Laraland
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2">
                    <div class="p-6">
                        ...
                        <div class="ml-12">
                            ...
                            >
                                特徴1の説明特徴1の説明特徴1の説明特徴1の説明特徴1の説明特徴1の説明特徴1の説明特徴1の説明特徴1の説明特徴1の説明特徴1の説明特徴1の説明特徴1の説明特徴1の説明特徴1の説明特徴1の説明特徴1の説明特徴1の説明
                            </div>
                        </div>
                    </div>
                    ...
                    >
                        ...
                        <div class="ml-12">
                            <div
                                class="mt-2 text-gray-600 dark:text-gray-400 text-sm"
                            >
                                特徴2の説明特徴2の説明特徴2の説明特徴2の説明特徴2の説明特徴2の説明特徴2の説明特徴2の説明特徴2の説明特徴2の説明特徴2の説明特徴2の説明特徴2の説明特徴2の説明特徴2の説明特徴2の説明特徴2の説明特徴2の説明
                            </div>
                        </div>
                    </div>
                    ...
                    >
                        ...
                        <div class="ml-12">
                            <div
                                class="mt-2 text-gray-600 dark:text-gray-400 text-sm"
                            >
                                特徴3の説明特徴3の説明特徴3の説明特徴3の説明特徴3の説明特徴3の説明特徴3の説明特徴3の説明特徴3の説明特徴3の説明特徴3の説明特徴3の説明特徴3の説明特徴3の説明特徴3の説明特徴3の説明特徴3の説明特徴3の説明
                            </div>
                        </div>
                    </div>
                    ...
                    >
                        ...
                        <div class="ml-12">
                            <div
                                class="mt-2 text-gray-600 dark:text-gray-400 text-sm"
                            >
                                特徴4の説明特徴4の説明特徴4の説明特徴4の説明特徴4の説明特徴4の説明特徴4の説明特徴4の説明特徴4の説明特徴4の説明特徴4の説明特徴4の説明特徴4の説明特徴4の説明特徴4の説明特徴4の説明特徴4の説明特徴4の説明
                            </div>
                        </div>
                    </div>
                </div>
